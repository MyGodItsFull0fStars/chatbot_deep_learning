...
\pagebreak
        ...
        \label{subsec:-data-preprocessing-augmenting}
            ...
            \label{par:-data-preprocessing-augmenting---tokenization}
                ...
                To be able to feed the dataset to the ML-model BERT, a tokenization process is necessary.
                ...
                Those encoded arrays called \texttt{input\_ids} contain special tokens required by BERT (see \ref{sect:-bert}) to properly understand the provided input. These arrays also contain the input ID for every word provided as an input to the tokenizer.
